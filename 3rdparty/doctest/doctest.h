...
#define DOCTEST_TEST_CASE_CLASS(decorators)                                              \
    DOCTEST_CREATE_AND_REGISTER_FUNCTION_IN_CLASS(                                       \
        DOCTEST_ANONYMOUS(_DOCTEST_ANON_FUNC_), DOCTEST_ANONYMOUS(_DOCTEST_ANON_PROXY_), \
        decorators)
...
#define DOCTEST_TEST_CASE_TEMPLATE(dec, T, ...)                                    \
    DOCTEST_TEST_CASE_TEMPLATE_IMPL(dec, T, DOCTEST_ANONYMOUS(_DOCTEST_ANON_TMP_), \
                                    __VA_ARGS__)
...
class MultiLaneAtomic
{
   ...
   private:
    ...
    // threads use this, some will use the same atomic. So performance will degrate a bit,
